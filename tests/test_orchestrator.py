...
class TestOrchestratorFinalization(unittest.TestCase):
    ...
    @patch("validators.git_validator.check_git_status")
    @patch("validators.finalization_validator.check_reflection_invoked")
...
class TestOrchestratorCleanState(unittest.TestCase):
    ...
    def test_run_clean_state_fails_on_feature_branch(self):
        ...
        with patch("validators.git_validator.check_branch_info") as mock_branch:
            mock_branch.return_value = ("agent-harness/test", True)
            with patch("validators.git_validator.check_git_status") as mock_git:
                mock_git.return_value = (True, "Clean")
